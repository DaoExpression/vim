...
# Note: 
# Now you can use scp to transfer, by refering your ssh-key: 
#
# Example: 
#
# scp -i ~/.ssh/server file app@greatsky.ddns.net 
#
# Please send an email to om@stk, confirming this setup. 
